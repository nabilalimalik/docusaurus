...
/* harmony export */ });
/* harmony import */ var _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(49137);
...
/* harmony import */ var _index_a92ac404_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(67064);
...
const getClasses = function(text, diagramObj) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("Extracting classes");
  diagramObj.db.clear();
  try {
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__.D) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(itemId, (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.c)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeTextOrArray(newNode.description, (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.c)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__.a ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__.b:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__.D:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.e.sanitizeText(item.description, (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.c)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles_fa41df25_js__WEBPACK_IMPORTED_MODULE_8__.c) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = async function(text, id, _version, diag) {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  diag.db.getDirection();
  const { securityLevel, state: conf } = (0,_mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const nodeSpacing = conf.nodeSpacing || 50;
  const rankSpacing = conf.rankSpacing || 50;
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.l.info(diag.db.getRootDocV2());
  ...
  await (0,_index_a92ac404_js__WEBPACK_IMPORTED_MODULE_9__.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
