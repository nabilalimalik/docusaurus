...
const setMessage = (txt) => {
  _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Setting message to: " + txt);
  message = txt;
};
const getMessage = () => {
  return message;
...
const db = {
  ...
  setInfo,
  getInfo,
  clear: _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.v
  // parseError
};
const getStyles = () => ``;
...
const draw = (text, id, version) => {
  try {
    ...
    _mermaid_b0ad2de1_js__WEBPACK_IMPORTED_MODULE_4__.l.error(e.message);
  }
};
const renderer = {
  draw
